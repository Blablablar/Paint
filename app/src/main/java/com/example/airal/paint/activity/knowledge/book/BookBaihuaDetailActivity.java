...
public class BookBaihuaDetailActivity extends BaseActivity {
    ...
    public void initView() {
        List<Bitmap> list = SysConfig.resizeBitmapList(SysConfig.drawableToBitmap(getResources().getDrawable(R.mipmap.book_baihua)));
        ...
        ivPlay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(ivPlay.isSelected()){
                    ...
                    CommonUtils.changeBookMusic(getBaseContext(), 0);
