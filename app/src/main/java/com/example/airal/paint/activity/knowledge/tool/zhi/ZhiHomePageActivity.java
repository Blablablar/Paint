...
public class ZhiHomePageActivity extends BaseActivity {
    @Override
    protected int getContentLayout() {
        return R.layout.activity_knowledge_tool_zhi;
    }
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            case R.id.iv_type_1:
                startActivity(new Intent(this, ZhiXuangouActivity.class));
                break;
            case R.id.iv_type_2:
                startActivity(new Intent(this, ZhiTypeActivity.class));
                break;
            default:
                break;
        }
