...
public class ZhiTypeActivity extends BaseActivity {
    ...
    public void initView() {
        List<Bitmap> list = SysConfig.resizeBitmapList(SysConfig.drawableToBitmap(getResources().getDrawable(R.drawable.zhi_type_detail)));
