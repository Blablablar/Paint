...
public class MoXuangouActivity extends BaseActivity {
    ...
    public void initView() {
        List<Bitmap> list = SysConfig.resizeBitmapList(SysConfig.drawableToBitmap(getResources().getDrawable(R.drawable.mo_xuangou_detail)));
